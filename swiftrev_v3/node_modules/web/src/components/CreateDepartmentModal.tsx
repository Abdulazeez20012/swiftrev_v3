...
const CreateDepartmentModal = ({ isOpen, onClose, onSuccess }: CreateDepartmentModalProps) => {
    ...
    return (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-md z-[70] flex items-center justify-center p-4 animate-in fade-in duration-300">
            <div className="bg-card w-full max-w-md rounded-[2.5rem] border border-border shadow-2xl relative overflow-hidden flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="p-8 pt-4 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <input
                                required
                                placeholder="e.g. Radiology, Cardiology, Pharmacy"
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        >
                            {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : 'Create Unit'}
                        </button>
                    </div>
                </form>
            </div>
